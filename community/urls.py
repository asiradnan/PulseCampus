...
urlpatterns = [
    ...
    path('<str:pk>/comment/delete', views.delete_comment, name='delete_comment'),
    path('<str:pk>/upvote/', views.upvote, name='upvote'),
    path('<str:pk>/downvote/', views.downvote, name='downvote'),
]